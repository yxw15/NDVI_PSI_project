...
plot_NDVI_PSI_month_species_linear_orig(data_all, 
                                        "results_rootzone/Figures_till2022/supplementary/NDVI_PSI_linear_slope_monthly_orig_till2022.png",
                                        "results_rootzone/Figures_till2022/supplementary/NDVI_PSI_linear_coeff_monthly_orig_till2022.png")
...
plot_NDVI_TDiff_month_species_linear_orig(data_all, 
                                          "results_rootzone/Figures_till2022/supplementary/NDVI_TDiff_linear_slope_monthly_orig_till2022.png",
                                          "results_rootzone/Figures_till2022/supplementary/NDVI_TDiff_linear_coeff_monthly_orig_till2022.png")
...
plot_density_NDVI_PSI_linear(data,
                             swp_bin_width = 50,
                             output_path = "results_rootzone/Figures_till2022/supplementary/NDVI_PSI_density_till2022.png")
...
plot_density_NDVI_TDiff_linear(data,
                               tdiff_bin_width = 3,
                               output_path = "results_rootzone/Figures_till2022/supplementary/NDVI_Tdiff_density_till2022.png")
...
plot_distribution_PSI_TDiff(
  ...
  output_file  = "results_rootzone/Figures_till2022/supplementary/mean_soil_water_potential_till2022.png"
)
...
plot_distribution_PSI_TDiff(
  ...
  output_file  = "results_rootzone/Figures_till2022/supplementary/mean_transpiration_deficit_till2022.png"
)
...
load("results/Data/mean_Temp_VPD_2003_2022.RData")
...
plot_mean_climate(all_df, var = "temp", legend_title = "temperature (°C)",
                  output_path = "results_rootzone/Figures_till2022/supplementary/mean_temperature_till2022.png")

plot_mean_climate(all_df, var = "vpd", legend_title = "VPD (kPa)",
                  output_path = "results_rootzone/Figures_till2022/supplementary/mean_vpd_till2022.png")
...
plot_bar_mean_PSI_TDiff_rootzone(data, "results_rootzone/Figures_till2022/supplementary/bar_mean_PSI_TDiff_rootzone_till2022.png")
...
plot_bar_mean_Temp_VPD(all_df, "results_rootzone/Figures_till2022/supplementary/bar_mean_temp_vpd_till2022.png")
...
plot_temp_vpd_time_series <- function(df,
                                      out_dir = "results_rootzone/Figures_till2022/supplementary",
                                      cb_palette = c(
                                        "Oak"    = "#E69F00",
                                        "Beech"  = "#0072B2",
                                        "Spruce" = "#009E73",
                                      ...
                                      filename = "TS_temp_VPD_all_species_till2022.png",
                                      caption_size = 14) {
  dir.create(out_dir, recursive = TRUE, showWarnings = FALSE)
  
  df <- df %>%
    mutate(
      # Convert to July 1st to center points in the middle of each year
      time = as.Date(paste0(format(time, "%Y"), "-07-01")),
      species = factor(species, levels = names(cb_palette))
    )
  
  # Create custom breaks at July 1st for every 2 years
  years <- unique(as.numeric(format(df$time, "%Y")))
  even_years <- years[years %% 2 == 1]  # Get odd years (2003, 2005, 2007, etc.)
  custom_breaks <- as.Date(paste0(even_years, "-07-01"))
  ...
  p_temp_base <- ggplot(df, aes(x = time, y = temp, color = species)) +
    ...
    theme_rootzone() +
    # Use custom breaks at July 1st for every 2 years
    scale_x_date(
...
# ====== 7) Save figure ======
load("results/Data/species_Temp_VPD_timeseries.RData")
ts_df <- ts_df %>%
  filter(as.numeric(format(time, "%Y")) < 2023) 

plot_temp_vpd_time_series(ts_df)
...
plot_mean_linear_coeffs(data, "results_rootzone/Figures_till2022/supplementary/coeffs_yearly_mean_till2022.png")
...
plot_combined_AIC_R2(data, "results_rootzone/Figures_till2022/supplementary/AIC_till2022.png")
...
source("R/plot_rootzone_diff_NDVI_TDiff.R")
